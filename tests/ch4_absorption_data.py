...
Z = [6.0, 1.0, 1.0, 1.0, 1.0]
Rc = np.array([-8.25958984966926, 3.92808224650772, 0.00000000])
Dtot = [0, 0, 0]
Daa = np.array(
    [
...
Aab = np.array([O, H1O, H1, H2O, H2H1, H2])
Aa = np.array(
    [
...
R = [
    [-8.2595898704563, 3.9280823277660, 0.0000000000000],
    [-7.5856106764906, 2.0217077156112, 0.0000000000000],
    [-7.5855758866326, 4.8812567648085, 1.6509620636898],
    [-7.5855758866326, 4.8812567648085, -1.6509620636898],
    [-10.2815968241994, 3.9281072532536, 0.0000000000000],
]
Qtot = -10.0
Q = rMP[0, 0, (0, 2, 5)]
D = rMP[1:4, 0, :]
