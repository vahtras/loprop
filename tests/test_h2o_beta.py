...
class TestH2OBeta(LoPropTestCase):
    ...
    def test_beta_zxx(self, molfrag):
        ...
        bzxx = -z & xx
        self.assert_allclose(bzxx, ref.Bm[2, 0], atol=0.005)
    ...
    def test_beta_xzx(self, molfrag):
        ...
        bxzx = -x & zx
        self.assert_allclose(bxzx, ref.Bm[0, 2], atol=0.005)
    ...
    def test_beta_xxz(self, molfrag):
        ...
        bxxz = -x & xz
        self.assert_allclose(bxxz, ref.Bm[0, 2], atol=0.005)
    ...
    def test_beta_yyz(self, molfrag):
        ...
        byyz = -y & yz
        self.assert_allclose(byyz, ref.Bm[1, 4], atol=0.005)
    ...
    def test_beta_zyy(self, molfrag):
        ...
        bzyy = -z & yy
        self.assert_allclose(bzyy, ref.Bm[2, 3], atol=0.005)
    ...
    def test_beta_zzz(self, molfrag):
        ...
        bzzz = -z & zz
        self.assert_allclose(bzzz, ref.Bm[2, 5], atol=0.005)
    ...
    def test_potfile_P0A0B1(self, molfrag):
        this = molfrag.output_potential_file(maxl=0, pol=0, hyper=1)
        self.assert_str(this, ref.P0A0B1)

    def test_potfile_P0A0B2(self, molfrag):
        this = molfrag.output_potential_file(maxl=0, pol=0, hyper=2)
        self.assert_str(this, ref.P0A0B2)

    def test_potfile_P0A0B1b(self, molfrag):
        this = molfrag.output_potential_file(maxl=0, pol=0, hyper=1, bond_centers=True)
